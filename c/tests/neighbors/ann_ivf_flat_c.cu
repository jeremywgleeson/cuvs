...
extern "C" void run_ivf_flat(int64_t n_rows, int64_t n_queries, int64_t n_dim,
...
TEST(IvfFlatC, BuildSearch) {
  ...
  run_ivf_flat(n_rows, n_queries, n_dim, n_neighbors, index_data.data(),
...
TEST(IvfFlatC, BuildSearchBitsetFiltered) {
  ...
  cuvsIvfFlatSearch(res, search_params, index, &queries_tensor,
